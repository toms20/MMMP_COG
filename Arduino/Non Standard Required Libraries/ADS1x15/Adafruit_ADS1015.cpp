...
*/
/**************************************************************************/
uint16_t Adafruit_ADS1015::readADC_SingleEnded(uint8_t channel, uint8_t gain) {
  if (channel > 3)
  {
    return 0;
  }
  ...
  // Set PGA/voltage range
    ...
    {
      case(0):
        config |= ADS1015_REG_CONFIG_PGA_6_144V;  // +/- 6.144V range (x 2/3)
        break;
      case(1):
        config |= ADS1015_REG_CONFIG_PGA_4_096V;  // +/- 4.096V range (x 1.0)
        break;
      case(2):
        config |= ADS1015_REG_CONFIG_PGA_2_048V;  // +/- 2.048V range (x 2.0)
        break;
      case(4):
        config |= ADS1015_REG_CONFIG_PGA_1_024V;  // +/- 1.024V range (x 4.0)
        break;
      case(8):
        config |= ADS1015_REG_CONFIG_PGA_0_512V;  // +/- 0.512V range (x 8.0)
        break;
      case(16):
        config |= ADS1015_REG_CONFIG_PGA_0_256V;  // +/- 0.256V range (x 16.0)
        break;
      default:
