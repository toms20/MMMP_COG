...
/*=========================================================================
    ...
    #define ADS1015_REG_CONFIG_PGA_6_144V   (0x0000)  // +/-6.144V range (000)
    #define ADS1015_REG_CONFIG_PGA_4_096V   (0x0200)  // +/-4.096V range (001)
    #define ADS1015_REG_CONFIG_PGA_2_048V   (0x0400)  // +/-2.048V range (default)
    #define ADS1015_REG_CONFIG_PGA_1_024V   (0x0600)  // +/-1.024V range (011)
    #define ADS1015_REG_CONFIG_PGA_0_512V   (0x0800)  // +/-0.512V range (100)
    #define ADS1015_REG_CONFIG_PGA_0_256V   (0x0A00)  // +/-0.256V range (101)
...
protected:
 ...
 public:
  ...
  void begin(void);
  uint16_t readADC_SingleEnded(uint8_t channel, uint8_t gain);
